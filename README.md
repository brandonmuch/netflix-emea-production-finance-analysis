...
A data analysis project simulating the core responsibilities of a **Data Analyst on Netflix's EMEA Production Finance team** — extracting, cleaning, modelling and visualising content and financial data across 35+ markets in Europe, the Middle East and Africa.

---

## Project Overview

This project mirrors the analytical workflow described in Netflix's Data Analyst, EMEA Production Finance role (JR37106). It demonstrates end-to-end data analysis across the following areas:
...
| Top market by volume | United Kingdom — 736 titles |
| Peak content year | 2020 — pandemic-driven surge |
| Movies share of EMEA | 72.4% |
| Top genre | International Movies — 996 titles |
| Africa vs Europe cost gap | 3.9% — markets rapidly converging |
| Modelled EMEA total budget | Based on Netflix 2024 Annual Report |

---

## Stakeholder Map

This analysis was framed around the following stakeholder needs — matching the cross-functional collaboration required in the actual role:
...
Note: This is a simulated financial model for analytical purposes. It demonstrates data modelling methodology using realistic industry benchmarks. In the actual role, analysis would use internal systems including the Global Spend Report data model referenced in the Netflix job specification.
...
2. Target underserved East and West African markets — Kenya, Ghana and Ethiopia
...
Open to relocation: London and Amsterdam
